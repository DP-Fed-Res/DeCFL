...
def register_module_validator(
    ...
    for training with customopacus.
    ...
    ... def validate(module: nn.Module, **kwargs) -> List[customopacus.validators.errors.UnsupportedError]:
    ...    pass

    It may help you to take a look at the existing validator inside customopacus, under ``customopacus.validators.``
    """
...
def register_module_fixer(
    ...
    it work for training with customopacus.
    ...
    It may help you to take a look at the existing fixers inside customopacus, under ``customopacus.validators.``
    """
