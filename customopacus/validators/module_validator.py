...
from customopacus.utils.module_utils import clone_module, get_submodule, trainable_modules
from customopacus.validators.errors import (
...
class ModuleValidator:
    """
    Encapsulates all the validation logic required by customopacus.
