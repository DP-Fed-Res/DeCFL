...
from customopacus.grad_sample.conv import convolution2d_backward_as_a_convolution
from customopacus.grad_sample.grad_sample_module import GradSampleModule
from customopacus.utils.tensor_utils import unfold2d
...
class Conv2d_test(GradSampleHooks_test):
    ...
    def test_unfold2d(
        ...
        X_unfold_customopacus = unfold2d(
            X,
            kernel_size=(k_h, k_w),
            padding=(pad_h, pad_w),
            stride=(stride_w, stride_h),
        ...
        assert_close(X_unfold_torch, X_unfold_customopacus, atol=0, rtol=0)
