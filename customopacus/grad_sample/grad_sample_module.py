...
from customopacus.grad_sample.functorch import ft_compute_per_sample_gradient, prepare_layer
from customopacus.grad_sample.gsm_base import AbstractGradSampleModule
from customopacus.layers.dp_rnn import DPGRU, DPLSTM, DPRNN, RNNLinear
from customopacus.utils.module_utils import (
        ...
        *,
        ...
        Args:
            ...
            strict: If set to ``True``, the input module will be validated to make sure that none of its submodules includes buffers,
                which is not currently supported by customopacus.
        ...
        errors.extend(
            [
                NotImplementedError(
                    ...
                    f"that customopacus doesn't currently support({m_name}:{m}). "
                )
