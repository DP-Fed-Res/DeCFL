...
class DPMultiheadAttention(nn.Module):
    ...
    def load_state_dict(self, state_dict):
        ...
        :class:`customopacus.layers.dp_multihead_attention.DPMultiheadAttention`.
    ...
    def forward(
        ...
        r"""
        As per https://github.com/pytorch/customopacus/issues/596, we have to include ``is_causal`` as a dummy parameter of the function,
