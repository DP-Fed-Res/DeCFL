...
from customopacus.optimizers import DPOptimizer


class _NoiseScheduler:
    """Base class for noise multiplier schedulers. We follow the same API
    as the standard PyTorch LR schedulers, but apply them to customopacus's noise
    multiplier param instead.

    This means it only works when you pass a customopacus.DPOptimizer, since that
